...
const quickS05 = planRow("quick-ache-relief-component-separation_2026-07-27.md", "safety", "S-05", "M/C");
...
reviewedOperation({ owners: [beverage], atomIds: ["atom.observe.titration-practice-decide", "atom.observe.titration-practice-observe", "atom.observe.titration-practice-read-initial", "atom.record.titration-practice-record-point", "atom.transfer.titration-practice-deliver", "atom.mix.titration-practice-mix", "atom.transfer.add-practice-indicator"], source: fruitPR03, reviewId: "item2-practice-drop-count-boundary-v3", sourceSupports: "the dropwise practice loop, stop-at-color-change observation and drop-count evidence", quantityAndConfigurationLimits: "Keep the owner uncalibrated practice label, teacher-selected indicator and maximum practice delivery; no source drop volume or retry rule is copied.", reviewStatus: "reviewed-authored-simulator-boundary", decisionDisposition: "reviewed-authored-boundary" });
...
reviewedOperation({ owners: [quick], atomIds: ["atom.transfer.fraction-dispose"], source: quickS05, reviewId: "item2-quick-liquid-waste-v3", sourceSupports: "putting liquid waste in the teacher-designated container", quantityAndConfigurationLimits: "Keep owner fraction identity, liquid/solid distinction and teacher-designated route; S-05 does not establish a universal container or volume." });
