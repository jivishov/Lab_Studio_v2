...
const commands = [
  ...
  {
    id: "09-recorder-check",
    args: ["scripts/recordCurrentVerificationRun.mjs", "--check", "--run-id", runId],
    expectedExitCode: 1,
    stdoutFile: "recorder-check.json",
    stderrFile: "recorder-check.stderr.log",
  },
  {
